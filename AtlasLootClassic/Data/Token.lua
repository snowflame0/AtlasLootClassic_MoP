...
if AtlasLoot:GameVersion_GE(AtlasLoot.MOP_VERSION_NUM) then
    TOKEN_DATA.MOP = {
        ...
        -- T16
        [99672] = { ICONS.PALADIN, 99029, 98979, 98985, 0, ICONS.PRIEST, 99020, 99024, 0, ICONS.WARLOCK, 99054, type = 6 }, -- Helm of Cursed Conqueror (Celestial)
        [99673] = { ICONS.HUNTER, 99080, 0, ICONS.MONK, 99065, 99069, 99073, 0, ICONS.SHAMAN, 99089, 98983, 98989, 0, ICONS.WARRIOR, 99032, 99046, type = 6 }, -- Helm of Cursed Protector (Celestial)
        [99671] = { ICONS.DEATHKNIGHT, 99057, 99049, 0, ICONS.DRUID, 99001, 98995, 99013, 99043, 0, ICONS.MAGE, 99084, 0, ICONS.ROGUE, 99008, type = 6 }, -- Helm of Cursed Vanquisher (Celestial)
        [99669] = { ICONS.PALADIN, 99027, 99076, 98987, 0, ICONS.PRIEST, 99005, 99018, 0, ICONS.WARLOCK, 99045, type = 6 }, -- Shoulder of Cursed Conqueror (Celestial)
        [99670] = { ICONS.HUNTER, 99082, 0, ICONS.MONK, 99051, 99062, 99075, 0, ICONS.SHAMAN, 99091, 98977, 98991, 0, ICONS.WARRIOR, 99030, 99036, type = 6 }, -- Shoulder of Cursed Protector (Celestial)
        [99668] = { ICONS.DEATHKNIGHT, 99059, 99040, 0, ICONS.DRUID, 98978, 98998, 99016, 99022, 0, ICONS.MAGE, 99079, 0, ICONS.ROGUE, 99010, type = 6 }, -- Shoulder of Cursed Vanquisher (Celestial)
        [99678] = { ICONS.PALADIN, 99031, 99003, 99052, 0, ICONS.PRIEST, 99004, 99017, 0, ICONS.WARLOCK, 99056, type = 6 }, -- Chest of Cursed Conqueror (Celestial)
        [99679] = { ICONS.HUNTER, 99085, 0, ICONS.MONK, 99063, 99061, 99071, 0, ICONS.SHAMAN, 99087, 98992, 99011, 0, ICONS.WARRIOR, 99037, 99047, type = 6 }, -- Chest of Cursed Protector (Celestial)
        [99677] = { ICONS.DEATHKNIGHT, 99066, 99060, 0, ICONS.DRUID, 98999, 98997, 99015, 99041, 0, ICONS.MAGE, 99078, 0, ICONS.ROGUE, 99006, type = 6 }, -- Chest of Cursed Vanquisher (Celestial)
        ...
        [99689] = { ICONS.PALADIN, 99128, 99135, 99138, 0, ICONS.PRIEST, 99122, 99117, 0, ICONS.WARLOCK, 99097, type = 6 }, -- Helm of Cursed Conqueror (Normal)
        [99694] = { ICONS.HUNTER, 99157, 0, ICONS.MONK, 99142, 99148, 99156, 0, ICONS.SHAMAN, 99093, 99103, 99109, 0, ICONS.WARRIOR, 99203, 99206, type = 6 }, -- Helm of Cursed Protector (Normal)
        [99683] = { ICONS.DEATHKNIGHT, 99194, 99190, 0, ICONS.DRUID, 99175, 99178, 99182, 99164, 0, ICONS.MAGE, 99161, 0, ICONS.ROGUE, 99114, type = 6 }, -- Helm of Cursed Vanquisher (Normal)
        [99690] = { ICONS.PALADIN, 99130, 99125, 99132, 0, ICONS.PRIEST, 99111, 99120, 0, ICONS.WARLOCK, 99205, type = 6 }, -- Shoulder of Cursed Conqueror (Normal)
        [99695] = { ICONS.HUNTER, 99159, 0, ICONS.MONK, 99144, 99146, 99151, 0, ICONS.SHAMAN, 99095, 99100, 99105, 0, ICONS.WARRIOR, 99196, 99200, type = 6 }, -- Shoulder of Cursed Protector (Normal)
        [99685] = { ICONS.DEATHKNIGHT, 99187, 99179, 0, ICONS.DRUID, 99169, 99173, 99184, 99166, 0, ICONS.MAGE, 99153, 0, ICONS.ROGUE, 99116, type = 6 }, -- Shoulder of Cursed Vanquisher (Normal)
        [99686] = { ICONS.PALADIN, 99126, 99133, 99136, 0, ICONS.PRIEST, 99110, 99119, 0, ICONS.WARLOCK, 99204, type = 6 }, -- Chest of Cursed Conqueror (Normal)
        [99691] = { ICONS.SHAMAN, 99101, 99106, 99107, 0, ICONS.MONK, 99140, 99150, 99154, 0, ICONS.HUNTER, 99167, 0, ICONS.WARRIOR, 99197, 99201, type = 6 }, -- Chest of Cursed Vanquisher (Normal)
        [99696] = { ICONS.DEATHKNIGHT, 99188, 99192, 0, ICONS.DRUID, 99170, 99172, 99177, 99180, 0, ICONS.MAGE, 99400, 0, ICONS.ROGUE, 99112, type = 6 }, -- Chest of Cursed Protector (Normal)
        ...
        [99724] = { ICONS.PALADIN, 99370, 99376, 99379, 0, ICONS.PRIEST, 99366, 99360, 0, ICONS.WARLOCK, 99425, type = 6 }, -- Helm of Cursed Conqueror (Heroic)
        [99725] = { ICONS.HUNTER, 99402, 0, ICONS.MONK, 99384, 99389, 99393, 0, ICONS.SHAMAN, 99332, 99341, 99353, 0, ICONS.WARRIOR, 99409, 99418, type = 6 }, -- Helm of Cursed Protector (Heroic)
        [99723] = { ICONS.DEATHKNIGHT, 99337, 99323, 0, ICONS.DRUID, 99421, 99433, 99436, 99328, 0, ICONS.MAGE, 99398, 0, ICONS.ROGUE, 99348, type = 6 }, -- Helm of Cursed Vanquisher (Heroic)
        [99718] = { ICONS.PALADIN, 99364, 99373, 99378, 0, ICONS.PRIEST, 99358, 99363, 0, ICONS.WARLOCK, 99417, type = 6 }, -- Shoulder of Cursed Conqueror (Heroic)
        [99719] = { ICONS.HUNTER, 99404, 0, ICONS.MONK, 99381, 99386, 99395, 0, ICONS.SHAMAN, 99334, 99343, 99346, 0, ICONS.WARRIOR, 99407, 99414, type = 6 }, -- Shoulder of Cursed Protector (Heroic)
        [99717] = { ICONS.DEATHKNIGHT, 99339, 99325, 0, ICONS.DRUID, 99423, 99428, 99431, 99322, 0, ICONS.MAGE, 99401, 0, ICONS.ROGUE, 99350, type = 6 }, -- Shoulder of Cursed Vanquisher (Heroic)
        [99715] = { ICONS.PALADIN, 99368, 99374, 99387, 0, ICONS.PRIEST, 99362, 99357, 0, ICONS.WARLOCK, 99416, type = 6 }, -- Chest of Cursed Conqueror (Heroic)
        [99716] = { ICONS.HUNTER, 99405, 0, ICONS.MONK, 99382, 99391, 99396, 0, ICONS.SHAMAN, 99344, 99347, 99351, 0, ICONS.WARRIOR, 99415, 99411, type = 6 }, -- Chest of Cursed Protector (Heroic)
        [99714] = { ICONS.DEATHKNIGHT, 99335, 99330, 0, ICONS.DRUID, 99419, 99427, 99430, 99326, 0, ICONS.MAGE, 99400, 0, ICONS.ROGUE, 99356, type = 6 }, -- Chest of Cursed Vanquisher (Heroic)
