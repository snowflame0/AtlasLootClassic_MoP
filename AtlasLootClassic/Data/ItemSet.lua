...
if AtlasLoot:GameVersion_GE(AtlasLoot.MOP_VERSION_NUM) then
    ITEM_SET_DATA_RAW.MOP = {
        ...
        [50011182] = {{99579,99645,99647,99580,99646},3,4,540,64,{{2,144998},{4,145003}},ALIL["Flexible"].." %s",1182}, -- Flexible"].." %s armony Regalia
        [50011183] = {{99615,99649,99663,99616,99650},3,4,540,64,{{2,144962},{4,144966}},ALIL["Flexible"].." %s",1183}, -- Flexible"].." %s armony Battlegear
        [50011184] = {{99636,99612,99614,99611,99613},3,4,540,64,{{2,145378},{4,145380}},ALIL["Flexible"].." %s",1184}, -- Flexible"].." %s armony Vestment
