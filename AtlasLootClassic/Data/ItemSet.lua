...
if AtlasLoot:GameVersion_GE(AtlasLoot.CATA_VERSION_NUM) then
    ITEM_SET_DATA_RAW.CATA = {
        ...
        [4004920] = {{70440,70434,70467,70441,70435},3,4,384,4,{{2,92258},{2,92254},{4,61256},{4,92257}},AL["Ruthless (Elite) %s"],920}, -- Hunter DPS
...
if AtlasLoot:GameVersion_GE(AtlasLoot.CATA_VERSION_NUM) then
    ITEM_TO_SET_DATA.CATA = {
        ...
        [63537] = 951, [63538] = 951,
        -- TODO Add source of all items from sets
    }
end
