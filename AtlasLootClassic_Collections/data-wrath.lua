...
data["DalaranVendor"] = {
    ...
    items = {{
        ...
        [NORMAL_DIFF] = {{1, "f1090rep8"}, -- caster
        ...
        name = ALIL["Gems"],
        [NORMAL_DIFF] = {{1, 36919}, -- Cardinal Ruby
...
data["CookingVendorWrath"] = {
    ...
    items = {{
        ...
        name = AL["Recipe"],
        [NORMAL_DIFF] = {{1, 43035}, -- Recipe: Blackened Dragonfin
...
data["EmblemofHeroism"] = {
    ...
    items = {{
        name = ALIL["Armor"],
        [NORMAL_DIFF] = {{1, 40697}, -- Elegant Temple Gardens' Girdle
        ...
        name = ALIL["Shield"],
        [NORMAL_DIFF] = {{1, 40701}, -- Crygil's Discarded Plate Panel
        {2, 40700} -- Protective Barricade of the Light
        }
    }, {
        name = ALIL["Off Hand"],
        [NORMAL_DIFF] = {{1, 40699}, -- Handbook of Obscure Remedies
        {2, 40698} -- Ward of the Violet Citadel
        }
    }, {
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 40679}, -- Chained Military Gorget
        ...
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 40684}, -- Mirror of Truth
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 40711}, -- Idol of Lush Moss
        ...
        name = AL["Token"],
        [NORMAL_DIFF] = {{1, 40610}, -- Chestguard of the Lost Conqueror
        ...
        name = ALIL["Misc"],
        [NORMAL_DIFF] = {{1, AtlasLoot:GetRetByFaction(44231, 44230)}, -- Reins of the Wooly Mammoth
        {3, 43102}, -- Frozen Orb
...
data["EmblemofValor"] = {
    ...
    items = {{
        name = ALIL["Armor"],
        [NORMAL_DIFF] = {{1, 40741}, -- Cuffs of the Shadow Ascendant
        ...
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 40724}, -- Cloak of Kea Feathers
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 40719}, -- Band of Channeled Magic
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 40342}, -- Idol of Awakening
        ...
        name = AL["Token"],
        [NORMAL_DIFF] = {{1, 40637}, -- Mantle of the Lost Conqueror
...
data["EmblemofConquest"] = {
    ...
    items = {{
        ...
        [NORMAL_DIFF] = {{1, 45837}, -- Gloves of Augury
        ...
        [NORMAL_DIFF] = {{1, 45833}, -- Bladebreaker Gauntlets
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 45820}, -- Broach of the Wailing Night
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 45509}, -- Idol of the Corruptor
        ...
        name = AL["Token"],
        [NORMAL_DIFF] = {{1, 45638}, -- Crown of the Wayward Conqueror
...
data["EmblemofTriumph"] = {
    ...
    items = {{
        ...
        name = ALIL["Weapon"],
        [NORMAL_DIFF] = {{1, 47659}, -- Crimson Star
        {2, 47660}, -- Blades of the Sable Cross
        {16, 47658} -- Brimstone Igniter
        }
    }, {
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 47735}, -- Glyph of Indomitability
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 47732}, -- Band of the Invoker
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 47671}, -- Idol of Flaring Growth
        ...
        name = AL["Misc"],
        [NORMAL_DIFF] = {{1, 47556}, -- Crusader Orb
...
data["EmblemofFrost"] = {
    ...
    items = {{
        name = ALIL["Armor"] .. " - " .. ALIL["Cloth"],
        [NORMAL_DIFF] = {{1, 50975}, -- Ermine Coronation Robes
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Leather"],
        [NORMAL_DIFF] = {{1, 50972}, -- Shadow Seeker's Tunic
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Mail"],
        [NORMAL_DIFF] = {{1, 50970}, -- Longstrider's Vest
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Plate"],
        [NORMAL_DIFF] = {{1, 50965}, -- Castle Breaker's Battleplate
        ...
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 50468}, -- Drape of the Violet Tower
        ...
        name = ALIL["Weapon"],
        [NORMAL_DIFF] = {{1, 50474} -- Shrapnel Star
        }
    }, {
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 50456}, -- Idol of the Crying Moon
        ...
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 50356}, -- Corroded Skeleton Key
        ...
        name = AL["Misc"],
        [NORMAL_DIFF] = {{1, 49908} -- Primordial Saronite
        }
    }}
}
...
data["SiderealEssence"] = {
    ...
    items = {{
        name = ALIL["Armor"] .. " - " .. ALIL["Cloth"],
        [NORMAL_DIFF] = {{1, 46068}, -- Amice of Inconceivable Horror
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Leather"],
        [NORMAL_DIFF] = {{1, 45993}, -- Mimiron's Flight Goggles
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Mail"],
        [NORMAL_DIFF] = {{1, 45300}, -- Mantle of Fiery Vengaence
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Plate"],
        [NORMAL_DIFF] = {{1, 46037}, -- Shoulderplates of the Celestial Watch
        ...
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 46032}, -- Drape of the Faceless General
        {16, 46042} -- Drape of the Messenger
        }
    }, {
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 46040}, -- Strength of the Heavens
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 46048}, -- Band of Lights
        ...
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 45931}, -- Mjolnir Runestone
        {2, 46038}, -- Dark Matter
        ...
        name = ALIL["Weapon"],
        [NORMAL_DIFF] = {{1, 46067}, -- Hammer of Crushing Whispers
        ...
        name = ALIL["Shield"],
        [NORMAL_DIFF] = {{1, 45877}, -- The Boreal Guard
...
data["MountsWrath"] = {
    ...
    items = {{
        ...
        name = AL["Drops"],
        [NORMAL_DIFF] = {{1, 50818}, -- Invincible's Reins
        ...
        name = AL["Crafting"],
        [NORMAL_DIFF] = {{1, 54797}, -- Frosty Flying Carpet
        ...
        TableType = AC_ITTYPE,
        [NORMAL_DIFF] = {AtlasLoot:GetRetByFaction({1, 44177, 2145}, {1, 44177, 2144}), -- Reins of the Violet Proto-Drake
...
data["CompanionsWrath"] = {
    ...
    items = {{
        name = AL["Drops"],
        [NORMAL_DIFF] = {{1, 48126}, --  Razzashi Hatchling
        ...
        name = AL["Vendor"],
        [NORMAL_DIFF] = {{1, 44723}, --  Nurtured Penguin Egg
        ...
        [NORMAL_DIFF] = {{1, 50446}, -- Toxic Wasteling
        ...
        name = ALIL["Achievements"],
        TableType = AC_ITTYPE,
        [NORMAL_DIFF] = {{1, 44810, AtlasLoot:GetRetByFaction(3656, 3478)}, --  Turkey Cage
        ...
        name = ALIL["Fishing"],
        [NORMAL_DIFF] = {{1, 43698}, --  Giant Sewer Rat
        {16, 44983} --  Strand Crawler
        }
    }, { -- Unobtainable
        name = AL["Unobtainable"],
        [NORMAL_DIFF] = {{1, 39286}, --  Frosty's Collar
        ...
        name = AL["Misc"],
        [NORMAL_DIFF] = {{1, 49287}, -- Tuskarr Kite
...
data["MidsummerFestivalWrath"] = {
    ...
    items = {{ -- MidsummerFestivalWrath
        name = AL["Midsummer Festival"],
        [NORMAL_DIFF] = {{1, 23083}, -- Captured Flame
...
data["PilgrimsBounty"] = {
    ...
    items = {{ -- Pilgrim's Bounty
        name = AL["Pilgrim's Bounty"],
        [NORMAL_DIFF] = {{1, 44860}, -- Recipe: Spice Bread Stuffing
...
data["ScourgeInvasionWrath"] = {
    ...
    items = {{ -- ScourgeInvasionEvent1
        name = AL["Vendor"],
        [NORMAL_DIFF] = {{1, 40492}, --  Argent War Horn
        {2, 40593}, --  Argent Tome
        ...
        [NORMAL_DIFF] = {{1, 781}, -- Blessed Regalia of Undead Cleansing
        ...
        [NORMAL_DIFF] = {{1, 38658}, -- Vampiric Batling
