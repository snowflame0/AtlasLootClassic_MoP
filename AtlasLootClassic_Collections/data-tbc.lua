...
data["BadgeofJustice"] = {
    ...
    items = {{
        ...
        [NORMAL_DIFF] = {{1, 32089}, -- Mana-Binders Cowl
        ...
        [NORMAL_DIFF] = {{1, 32087}, -- Mask of the Deceiver
        ...
        [NORMAL_DIFF] = {{1, 32085}, -- Warpstalker Helm
        ...
        [NORMAL_DIFF] = {{1, 32083}, -- Faceguard of Determination
        ...
        name = ALIL["Off Hand"],
        [NORMAL_DIFF] = {{1, 29266}, -- Azure-Shield of Coldarra
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 29368}, -- Manasurge Pendant
        ...
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 29369}, -- Shawl of Shifting Probabilities
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 29367}, -- Ring of Cryptic Dreams
        ...
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 29370}, -- Icon of the Silver Crescent
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 29388}, -- Libram of Repentance
...
data["BadgeofJustice4"] = {
    ...
    items = {{
        name = ALIL["Armor"] .. " - " .. ALIL["Cloth"],
        [NORMAL_DIFF] = {{1, 33588}, {2, 33586}, {3, 33291}, {4, 33584}, {6, 33589}, {7, 33587}, {8, 33585}}
    }, {
        name = ALIL["Armor"] .. " - " .. ALIL["Leather"],
        [NORMAL_DIFF] = {{1, 33972}, {2, 33973}, {3, 33566}, {4, 33578}, {5, 33974}, {6, 33559}, {7, 33577}, {9, 33287},
                         {10, 33557}, {11, 33552}, {16, 33579}, -- bonus armor
        {17, 33580}, -- bonus armor
        {18, 33583}, -- bonus armor
        {19, 33582}, -- bonus armor
        {21, 33540}, {22, 33539}, {23, 33538}, {24, 33222}}
    }, {
        name = ALIL["Armor"] .. " - " .. ALIL["Mail"],
        [NORMAL_DIFF] = {{1, 33970}, {2, 33965}, {3, 33535}, {4, 33524}, {5, 33536}, {6, 33537}, {8, 33529}, {9, 33528},
                         {10, 33280}, {11, 33527}, {16, 33532}, {17, 33531}, {18, 33386}, {19, 33530}, {20, 33324}}
    }, {
        name = ALIL["Armor"] .. " - " .. ALIL["Plate"],
        [NORMAL_DIFF] = {{1, 33810}, {2, 33514}, {3, 33513}, {4, 33331}, {5, 33512}, {6, 33501}, {8, 33520}, {9, 33519},
                         {10, 33518}, {11, 33207}, {16, 33522}, {17, 33516}, {18, 33517}, {19, 33279}, {20, 33524},
                         {21, 33515}, {22, 33523}}
    }, {
        name = ALIL["Off Hand"],
        [NORMAL_DIFF] = {{1, 33334}, {2, 33325}}
    }, {
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 33296}}
    }, {
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 33593}, {2, 35321}, {3, 33304}, {4, 35324}, {5, 33484}, {6, 33333}}
    }, {
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 35326}, {2, 34049}, {3, 34162}, {4, 34163}, {5, 33832}, {6, 34050}}
    }, {
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, "INV_Box_01", nil, AL["Idols"]}, {2, 33510}, {3, 33509}, {4, 33508},
                         {6, "INV_Box_01", nil, AL["Librams"]}, {7, 33503}, -- Libram of Divine Judgement
        {8, 33502}, -- Libram of Mending
        {9, 33504}, -- Libram of Divine Purpose
        {16, "INV_Box_01", nil, AL["Totems"]}, {17, 33506}, {18, 33507}, {19, 33505}}
    }, {
        name = ALIL["Wand"],
        [NORMAL_DIFF] = {{1, 33192} -- Carved Witch Doctor Stick
        }
    }}
}
...
data["BadgeofJusticeP5"] = {
    ...
    items = {{
        name = ALIL["Armor"] .. " - " .. ALIL["Cloth"],
        [NORMAL_DIFF] = {{1, 34926}, {2, 34924}, {3, 34925}, {5, 34919}, {6, 34917}, {7, 34918}, {9, 34938},
                         {10, 34936}, {11, 34937}}
    }, {
        name = ALIL["Armor"] .. " - " .. ALIL["Leather"],
        [NORMAL_DIFF] = {{1, 34911}, -- bonus armor
        {2, 34906}, -- bonus armor
        {3, 34910}, -- bonus armor
        {5, 34929}, -- AP
        {6, 34927}, -- AP
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 34887}, {2, 34890}, {3, 34889}, {4, 34888}}
    }, {
        name = ALIL["Gem"],
        [NORMAL_DIFF] = {{1, 32228}, {2, 32249}, {3, 32231}, {4, 32230}, {5, 32227}, {6, 32229}}
    }}
}
...
data["BCCSunmote"] = {
    ...
    items = {{
        name = ALIL["Armor"] .. " - " .. ALIL["Cloth"],
        [NORMAL_DIFF] = {{1, 34405}, -- Helm of Arcane Purity
        ...
        name = ALIL["Armor"] .. " - " .. ALIL["Mail"],
        [NORMAL_DIFF] = {{1, 34402}, -- Cover of Ursoc the Mighty
...
data["MountsBC"] = {
    ...
    items = {{
        ...
        name = AL["Reputation"],
        [ALLIANCE_DIFF] = {{1, 29227}, -- Reins of the Cobalt War Talbuk
        ...
        [HORDE_DIFF] = {{1, 29102}, -- Reins of the Cobalt War Talbuk
        ...
        name = AL["Crafting"],
        [NORMAL_DIFF] = {{1, 34061}, -- Turbo-Charged Flying Machine Control
...
data["CompanionsBC"] = {
    ...
    items = {{
        ...
        name = AL["Quest"],
        [NORMAL_DIFF] = {{1, 31760} -- Miniwing
        }
    }, {
        name = AL["Vendor"],
        [NORMAL_DIFF] = {{1, 34478}, -- Tiny Sporebat
        ...
        [NORMAL_DIFF] = {{1, 34425}, -- Clockwork Rocket Bot
        ...
        name = ALIL["Fishing"],
        [NORMAL_DIFF] = {{1, 35350}, -- Chuck's Bucket
        ...
        name = AL["Unobtainable"],
        [NORMAL_DIFF] = {{1, 34493}, -- Dragon Kite
...
data["LegendarysBC"] = {
    ...
    items = {{
        ...
        MapID = 3845,
        [NORMAL_ITTYPE] = {{1, 30312}, -- Infinity Blade
        {2, 30311}, -- Warp Slicer
