...
local T9_SET = {
    ...
    -- ContentPhaseBC = 6,
    IgnoreAsSource = true,
    [NORMAL_DIFF] = AtlasLoot:GetRetByFaction({ -- horde
    {1, 3000845}, -- Warlock
    ...
    [RAID25_DIFF] = AtlasLoot:GetRetByFaction({ -- horde
    {1, 3250845}, -- Warlock
    ...
    [RAID25H_DIFF] = AtlasLoot:GetRetByFaction({ -- horde
    {1, 3251845}, -- Warlock
...
local WOTLK_DUNGEONMASTER_AC_TABLE = { -- [Northrend Dungeonmaster]
    ...
    [NORMAL_DIFF] = {{1, 1288}, {2, 477}, {17, 478}, {3, 479}, {18, 480}, {4, 481}, {19, 482}, {5, 483}, {20, 484},
                     {6, 485}, {21, 486}, {7, 487}, {22, 488}}
}
...
local WOTLK_DUNGEON_HERO_AC_TABLE = { -- [Northrend Dungeon Hero]
    ...
    IgnoreAsSource = true,
    CoinTexture = "Achievement",
    [HEROIC_DIFF] = {{1, 1289}, {2, 489}, {17, 490}, {3, 500}, {18, 491}, {4, 492}, {19, 493}, {5, 494}, {20, 495},
                     {6, 496}, {21, 497}, {7, 498}, {22, 499}}
}
...
local WOTLK_GLORY_OF_THE_HERO_AC_TABLE = { -- [Glory of the Hero]
    ...
    IgnoreAsSource = true,
    CoinTexture = "Achievement",
    [HEROIC_DIFF] = {{1, 2136, 44160}, {2, 1919}, {17, 2150}, {3, 2036}, {18, 2037}, {4, 1296}, {19, 1297}, {5, 1860},
                     {20, 1862}, {6, 2038}, {21, 2056}, {7, 2151}, {22, 2039}, {8, 2057}, {23, 1816}, {9, 1865},
                     {24, 2041}, {10, 2153}, {25, 1864}, {11, 2152}, {26, 2040}, {12, 2058}, {27, 1866}, {13, 2154},
                     {28, 2155}, {14, 1867}, {29, 1834}, {15, 2042}, {30, 1817}, {101, 1872}, {116, 2043}, {102, 1873},
                     {117, 2156}, {103, 2157}, {118, 1871}, {104, 1868}, {119, 2044}, {105, 2045}, {120, 2046}}
}
...
local WOTLK_NAXXRAMAS_AC_TABLE = { -- [Glory of the Raider]
    ...
    IgnoreAsSource = true,
    CoinTexture = "Achievement",
    [RAID10_DIFF] = {{1, 2137, 44175}, {2, 578}, {17, 1858}, {3, 1856}, {18, 1996}, {4, 1997}, {19, 2178}, {5, 2180},
                     {20, 622}, {6, 1874}, {21, 1869}, {7, 2047}, {22, 2051}, {8, 2146}, {23, 2176}, {9, 2148},
                     {24, 2184}, {10, 2187}},
    [RAID25_DIFF] = {{1, 2138, 44164}, {2, 579}, {17, 1859}, {3, 1857}, {18, 2139}, {4, 2140}, {19, 2179}, {5, 2181},
                     {20, 623}, {6, 1875}, {21, 1870}, {7, 2048}, {22, 2054}, {8, 2147}, {23, 2177}, {9, 2149},
                     {24, 2185}, {10, 2186}}
}
...
local WOTLK_ULDUAR_AC_TABLE = { -- [Glory of the Ulduar Raider]
    ...
    IgnoreAsSource = true,
    CoinTexture = "Achievement",
    [RAID10_DIFF] = {{1, 2957, 45802}, {2, 3056}, {17, 2930}, {3, 2923}, {18, 3058}, {4, 2941}, {19, 2953}, {5, 3006},
                     {20, 3182}, {6, 3176}, {21, 3179}, {7, 3180}, {22, 3181}, {8, 3158}},
    [RAID25_DIFF] = {{1, 2958, 45801}, {2, 3057}, {17, 2929}, {3, 2924}, {18, 3059}, {4, 2944}, {19, 2954}, {5, 3007},
                     {20, 3184}, {6, 3183}, {21, 3187}, {7, 3189}, {22, 3188}, {8, 3163}}
}
...
local WOTLK_ICC_AC_TABLE = { -- [Glory of the Icecrown Raider]
    ...
    ExtraList = true,
    CoinTexture = "Achievement",
    [RAID10_DIFF] = {{1, 4602, 51954}, {2, 4534}, {17, 4535}, {3, 4536}, {18, 4537}, {4, 4538}, {19, 4577}, {5, 4578},
                     {20, 4582}, {6, 4539}, {21, 4579}, {7, 4580}, {22, 4601}},
    [RAID10H_DIFF] = {{1, 4602, 51954}, {2, 4628}, {17, 4629}, {3, 4630}, {18, 4631}},
    [RAID25_DIFF] = {{1, 4603, 51955}, {2, 4610}, {17, 4611}, {3, 4612}, {18, 4613}, {4, 4614}, {19, 4615}, {5, 4616},
                     {20, 4617}, {6, 4618}, {21, 4619}, {7, 4620}, {22, 4621}, {8, 4622}},
    [RAID25H_DIFF] = {{1, 4603, 51955}, {2, 4632}, {17, 4633}, {3, 4634}, {18, 4635}}
}
...
data["AhnKahet"] = {
    ...
    items = {{ -- AhnkahetNadox / 15
        ...
        {8, "ac2038"}},
        [ALPHA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        {12, "ac2038"}},
        [BETA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        {3, 45314}, -- Igniter Rod
        ...
        {16, "INV_Box_01", nil, AL["Tier Token iLvl200"], nil, "Tier7TitanRuneTokens"},
                       {17, "INV_Box_01", nil, AL["Tier Token iLvl225"], nil, "Tier8TitanRuneTokens"}, {19, 43102}, -- Frozen Orb
                       {21, 41790}, -- Design: Precise Scarlet Ruby
        {23, "ac1862"}, {101, 40616}, -- Helm of the Lost Conqueror
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 35616}, -- Spored Tendrils Spaulders
...
data["AzjolNerub"] = {
    ...
    items = {{ -- AzjolNerubKrikthir / 11
        ...
        name = AL["Trash"],
        ExtraList = true,
        [HEROIC_DIFF] = {{1, 37243}, -- Treasure Seeker's Belt
...
data["DrakTharonKeep"] = {
    ...
    items = {{ -- DrakTharonKeepTrollgore / 21
        ...
        Level = 76,
        DisplayIDs = {{26292}},
        [NORMAL_DIFF] = {{1, 35632}, -- Robes of Novos
        ...
        {16, "INV_Box_01", nil, AL["Tier Token iLvl200"], nil, "Tier7TitanRuneTokens"},
                       {17, "INV_Box_01", nil, AL["Tier Token iLvl225"], nil, "Tier8TitanRuneTokens"}, {19, 43102}, -- Frozen Orb { 21, 41796 }, -- Design: Infused Twilight Opal
                       {23, "ac1860"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 35641}, -- Scytheclaw Boots
        {2, 35640}, -- Darkweb Bindings
        {3, 35639} -- Brighthelm of Guarding
        },
        [HEROIC_DIFF] = {{1, 37799}, -- Reanimator's Cloak
...
data["Gundrak"] = {
    ...
    items = {{ -- GundrakSladran / 34
        ...
        {12, "ac2040"}},
        [BETA_DIFF] = {{1, 45299}, -- Emblem of Conquest
        ...
        {16, "INV_Box_01", nil, AL["Tier Token iLvl200"], nil, "Tier7TitanRuneTokens"},
                       {17, "INV_Box_01", nil, AL["Tier Token iLvl225"], nil, "Tier8TitanRuneTokens"}, {19, 43102}, -- Frozen Orb
                       {21, "ac2152"}, {23, "ac1864"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 35594}, -- Snowmelt Silken Cinch
        {2, 35593}, -- Steel Bear Trap Bracers
        {3, 37646} -- Burning Skull Pendant
        },
        [HEROIC_DIFF] = {{1, 37647}, -- Cloak of Bloodied Waters
...
data["HallsofLightning"] = {
    ...
    items = {{ -- HallsofLightningBjarngrim / 45
        ...
        {23, "ac1867"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 36997}, -- Sash of the Hardened Watcher
        {2, 37000}, -- Storming Vortex Bracers
        {3, 36999} -- Boots of the Terrestrial Guardian
        },
        [HEROIC_DIFF] = {{1, 37858}, -- Awakened Handguards
...
data["HallsofStone"] = {
    ...
    items = {{ -- HallsofStoneKrystallus / 41
        ...
        {16, "INV_Box_01", nil, AL["Tier Token iLvl200"], nil, "Tier7TitanRuneTokens"},
                       {17, "INV_Box_01", nil, AL["Tier Token iLvl225"], nil, "Tier8TitanRuneTokens"}, {19, 43102}, -- Frozen Orb
                       {21, 41799}, -- Design: Eternal Earthsiege Diamond
        {23, "ac2155"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 35682}, -- Rune Giant Bindings
        {2, 35683}, -- Palladium Ring
        {3, 35681} -- Unrelenting Blade
        },
        [HEROIC_DIFF] = {{1, 37673}, -- Dark Runic Mantle
...
data["TheCullingOfStratholme"] = {
    ...
    items = {{ -- CoTStratholmeMeathook
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 37117}, -- King's Square Bracers
...
data["TheNexus"] = {
    ...
    items = {{ -- TheNexusKolurgStoutbeardHEROIC / 9
        ...
        Level = 72,
        DisplayIDs = AtlasLoot:GetRetByFaction({{24352}},{{24366}}),
        [HEROIC_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        {8, "ac2150"}, {16, 21524} -- Red Winter Hat
        },
        [ALPHA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        {12, "ac2150"}, {16, 21524} -- Red Winter Hat
        },
        [BETA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        {10, "ac2150"}, {16, 21524} -- Red Winter Hat
        }
    }, { -- TheNexusAnomalus / 7
        name = AL["Anomalus"],
        npcID = 26763,
        ...
        {23, "ac2036"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
...
data["TheOculus"] = {
    ...
    items = {{ -- OcuDrakos / 61
        ...
        {20, "ac1868"}, {21, "ac1871"}, {22, "ac2046"}, {23, "ac2045"}, {24, "ac2044"}},
        [ALPHA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        {3, 37361}, -- Cuffs of Winged Levitation
        {4, 37363}, -- Gauntlets of Dragon Wrath
        {5, 37362}, -- Leggings of Protective Auras
        ...
        {23, "ac1868"}, {24, "ac1871"}, {25, "ac2046"}, {26, "ac2045"}, {27, "ac2044"},
                        {29, "INV_Box_01", nil, AL["Tier drops on next page"], nil},
                        {30, "INV_Box_01", nil, AL["Click the > button down below"], nil}, {101, 40616}, -- Helm of the Lost Conqueror
                        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        {23, "ac1868"}, {24, "ac1871"}, {25, "ac2046"}, {26, "ac2045"}, {27, "ac2044"}, {101, 40616}, -- Helm of the Lost Conqueror
                       {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 36978}, -- Ley-Whelphide Belt
        {2, 36977}, -- Bindings of the Construct
        {3, 36976} -- Ring-Lord's Leggings
        },
        [HEROIC_DIFF] = {{1, 37366}, -- Drake-Champion's Bracers
...
data["VioletHold"] = {
    ...
    ContentType = DUNGEON_CONTENT,
    LevelRange = {70, 75, 77},
    items = {{ -- VioletHoldErekem / 26
        name = AL["Erekem"],
        npcID = 29315,
        Level = 75,
        DisplayIDs = {{27488}},
        [NORMAL_DIFF] = {{1, 43363}, -- Screeching Cape
        ...
        Level = 75,
        DisplayIDs = {{27855}},
        [NORMAL_DIFF] = {{1, 43353}, -- Void Sentry Legplates
        ...
        Level = 75,
        DisplayIDs = {{27486}},
        [NORMAL_DIFF] = {{1, 35644}, -- Xevozz's Belt
        {2, 35642} -- Riot Shield
        },
        [HEROIC_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        Level = 75,
        DisplayIDs = {{27487}},
        [NORMAL_DIFF] = {{1, 35647}, -- Handguards of Rapid Pursuit
        ...
        Level = 75,
        DisplayIDs = {{20590}},
        [NORMAL_DIFF] = {{1, 43387}, -- Shoulderplates of the Beholder
        ...
        Level = 75,
        DisplayIDs = {{10193}},
        [NORMAL_DIFF] = {{1, 35646}, -- Lava Burn Gloves
        ...
        Level = 75,
        DisplayIDs = {{27508}},
        [NORMAL_DIFF] = {{1, 35650}, -- Boots of the Portal Guardian
        ...
        {23, "ac1816"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 35654}, -- Bindings of the Bastille
        {2, 35653}, -- Dungeon Girdle
        {3, 35652} -- Incessant Torch
        },
        [HEROIC_DIFF] = {{1, 35654}, -- Bindings of the Bastille
...
data["UtgardeKeep"] = {
    ...
    items = {{ -- UtgardeKeepKeleseth / 2
        ...
        {23, "ac1658"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 35580}, -- Skein Woven Mantle
...
data["UtgardePinnacle"] = {
    ...
    items = {{ -- UPSorrowgrave / 58
        ...
        Level = 77,
        DisplayIDs = {{27418}},
        [NORMAL_DIFF] = {{1, 37055}, -- Silken Amice of the Ymirjar
        ...
        {8, "ac1873"}, {9, "ac2156"}, {16, 44151} -- Reins of the Blue Proto-Drake
        },
        [ALPHA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        {12, "ac1873"}, {13, "ac2156"}, {16, 44151} -- Reins of the Blue Proto-Drake
        },
        [BETA_DIFF] = {{1, 45624}, -- Emblem of Conquest
        ...
        {10, "ac1873"}, {11, "ac2156"}, {16, 44151} -- Reins of the Blue Proto-Drake
        }
    }, { -- UPYmiron / 57
        name = AL["King Ymiron"],
        npcID = 26861,
        ...
        {23, "ac1790"}, {24, "ac2157"}, {101, 40616}, -- Helm of the Lost Conqueror
        {102, 40617}, -- Helm of the Lost Protector
        {103, 40618}, -- Helm of the Lost Vanquisher
        {104, 40622}, -- Spaulders of the Lost Conqueror
        {105, 40623}, -- Spaulders of the Lost Protector
        ...
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 37070}, -- Tundra Wolf Boots
        {2, 37069}, -- Dragonflayer Seer's Bindings
        {3, 37068} -- Berserker's Sabatons
        },
        [HEROIC_DIFF] = {{1, 37587}, -- Ymirjar Physician's Robe
...
data["TrialoftheChampion"] = {
    ...
    items = {{ -- TrialoftheChampionChampions / 213
        ...
        npcID = {34705, 34702, 34657, 34703, 34701, 35572, 35569, 35571, 35570, 35617},
        ObjectID = 195709,
        Level = 80,
        DisplayIDs = {{28560, 28586, 28735, 28564, 28736, 28587, 28637, 28597, 28588, 28589}},
        [NORMAL_DIFF] = {{1, 47173}, -- Bindings of the Wicked
        ...
        {8, "ac3803"}, {16, 47501}, -- Kurisu's Indecision
        ...
        {4, 45311}, -- Relentless Edge
        {6, 44990}, -- Champion's Seal
        {8, "ac3802"}, {16, 47498}, -- Gloves of Dismal Fortune
        {17, 47496}, -- Armbands of the Wary Lookout
        ...
        {7, "INV_Box_01", nil, AL["Tier Token iLvl200"], nil, "Tier7TitanRuneTokens"},
                       {8, "INV_Box_01", nil, AL["Tier Token iLvl225"], nil, "Tier8TitanRuneTokens"}, {10, 43102}, -- Frozen Orb
                       {12, "ac3804"}, {16, 47564}, -- Gaze of the Unknown
...
local ICC_DUNGEONS_TRASH = { -- Trash
    name = AL["Trash"],
    ExtraList = true,
    [NORMAL_DIFF] = {{1, 49854}, -- Mantle of Tattered Feathers
    {2, 49855}, -- Plated Grips of Korth'azz
    {3, 49853}, -- Titanium Links of Lore
    {4, 49852} -- Coffin Nail
    },
    [HEROIC_DIFF] = {{1, 50318}, -- Ghostly Wristwraps
...
data["ForgeOfSouls"] = {
    ...
    items = {{ -- FoSBronjahm / 268
        ...
        [HEROIC_DIFF] = {{1, 50193}, -- Very Fashionable Shoulders
        ...
        [HEROIC_DIFF] = {{1, 50213}, -- Mord'rethar Robes
...
data["PitOfSaron"] = {
    ...
    items = {{ -- PoSGarfrost / 271
        ...
        [HEROIC_DIFF] = {{1, 50233}, -- Spurned Val'kyr Shoulderguards
        ...
        [HEROIC_DIFF] = {{1, 50266}, -- Ancient Polar Bear Hide
        ...
        [HEROIC_DIFF] = {{1, 50286}, -- Prelate's Snowshoes
...
data["HallsOfReflection"] = {
    ...
    items = {{ -- HoRFalric / 275
        ...
        [HEROIC_DIFF] = {{1, 50292}, -- Bracer of Worn Molars
        ...
        [HEROIC_DIFF] = {{1, 50298}, -- Sightless Crown of Ulmaas
        ...
        [HEROIC_DIFF] = {{1, 50314}, -- Strip of Remorse
...
data["NaxxramasWrath"] = {
    ...
    { -- NAXAnubRekhan
        ...
        DisplayIDs = {{15931}},
        NameColor = BLUE,
        [NORMAL_DIFF] = {{1, 39719}, -- Mantle of the Locusts
        ...
        DisplayIDs = {{15940}},
        NameColor = BLUE,
        [NORMAL_DIFF] = {{1, 39732}, -- Faerlina's Madness
    ...
    { -- NAXNoththePlaguebringer
        ...
        DisplayIDs = {{16590}},
        NameColor = PURPLE,
        [NORMAL_DIFF] = {{1, 40602}, -- Robes of Mutation
    ...
    { -- NAXPatchwerk
        ...
        {20, "ac2178"}, {21, "ac2180"}, {23, "ac2179"}, {24, "ac2181"}}
    }, -- Frostwyrm Lair
    { -- NAXSapphiron
        name = AL["Sapphiron"],
        npcID = 15989,
        ...
        {24, "ac572"}, {25, "ac2146"}, {27, "ac573"}, {28, "ac2147"}}
    }, { -- NAXKelThuzard
        name = AL["Kel'Thuzad"],
        npcID = 15990,
        Level = 999,
        DisplayIDs = {{15945}},
        NameColor = GREEN,
        [NORMAL_DIFF] = {{1, 40405}, -- Cape of the Unworthy Wizard
        ...
        {20, "ac1658"}, {22, "ac574"}, {23, "ac2184"}, {25, "ac575"}, {26, "ac2185"}}
    }, { -- NAXTrash
        name = AL["Trash"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 40410}, -- Shadow of the Ghoul
    ...
    }, T7_SET, WOTLK_NAXXRAMAS_AC_TABLE}
}
...
data["ObsidianSanctum"] = {
    ...
    items = {{ -- CoTHillsbradDrake
        ...
        {7, "INV_Box_01", nil, AL["Two Drakes Left"]}, {8, 44005}, -- Pennant Cloak
        {9, 44008}, -- Unsullied Cuffs
        {10, 44007}, -- Headpiece of Reconciliation
        {11, 44011}, -- Leggings of the Honored
        {12, 44006}, -- Obsidian Greathelm
        {16, "INV_Box_01", nil, AL["Three Drakes Left"]}, {17, 43954} -- Reins of the Twilight Drake
        }
    }, T7_SET}
}
...
data["Ulduar"] = {
    ...
    items = {{ -- UlduarLeviathan
        ...
        {18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarFlameLeviathan25"},
                         {25, "ac3057", nil, nil, AL["Hard Mode"]}, {26, 45135}, -- Boots of Fiery Resolution
        ...
        {16, "ac2927"}, {17, "ac2925"}, {18, "ac2930"}},
        [RAID25_DIFF] = {{1, 45186}, -- Soot-Covered Mantle
        {2, 45185}, -- Flamewrought Cinch
        {3, 45162}, -- Flamestalker Boots
        {4, 45164}, -- Helm of the Furnace Master
        {5, 45187}, -- Wristguards of the Firetender
        ...
        {16, "ac2919"}, {17, "ac2923"}},
        [RAID25_DIFF] = {{1, 45138}, -- Drape of the Drakerider
        {2, 45150}, -- Collar of the Wyrmhunter
        {3, 45146}, -- Shackles of the Odalisque
        {4, 45149}, -- Bracers of the Broodmother
        {5, 45141}, -- Proto-hide Leggings
        ...
        {16, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarXTDeconstructor10"},
                         {25, "ac3058", nil, nil, AL["Hard Mode"]}, {26, 45869}, -- Fluxing Energy Coils
        ...
        [RAID25_DIFF] = {{1, 45253}, -- Mantle of Wavering Calm
        {2, 45258}, -- Sandals of Rash Temperament
        {3, 45260}, -- Boots of Hasty Revival
        {4, 45259}, -- Quartz-studded Harness
        {5, 45249}, -- Brass-lined Boots
        ...
        {18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarXTDeconstructor25"},
                         {25, "ac3059", nil, nil, AL["Hard Mode"]}, {26, 45446}, -- Grasps of Reason
        ...
        {16, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarCouncil10"},
                         {24, "ac2941", nil, nil, AL["Hard Mode"]}, {25, 45455}, -- Belt of the Crystal Tree
        ...
        [RAID25_DIFF] = {{1, 45224}, -- Drape of the Lithe
        {2, 45240}, -- Raiments of the Iron Council
        {3, 45238}, -- Overload Legwraps
        {4, 45237}, -- Phaelia's Vestments of the Sprouting Seed
        {5, 45232}, -- Runed Ironhide Boots
        ...
        {18, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarCouncil25"},
                         {23, "ac2944", nil, nil, AL["Hard Mode"]}, {24, 45242}, -- Drape of Mortal Downfall
        ...
        {16, "ac2953"}, {17, "ac2955"}, {18, "ac2959"}, {19, "ac2951"}},
        [RAID25_DIFF] = {{1, 45272}, -- Robes of the Umbral Brute
        {2, 45275}, -- Bracers of Unleashed Magic
        {3, 45273}, -- Handwraps of Plentiful Recovery
        {4, 45265}, -- Shoulderpads of the Monolith
        {5, 45274}, -- Leggings of the Stoneweaver
        ...
        {15, 45261}, -- Giant's Bane
        {16, 45038}, -- Fragment of Val'anyr
        {18, "ac2954"}, {19, "ac2956"}, {20, "ac2960"}, {21, "ac2952"}}
    }, { -- UlduarAlgalon
        ...
        [RAID25_DIFF] = {{1, 45665}, -- Pharos Gloves
        ...
        {16, "ac3006"}, {17, "ac3076"}},
        [RAID25_DIFF] = {{1, 45319}, -- Cloak of the Makers
        {2, 45435}, -- Cowl of the Absolute
        {3, 45441}, -- Sandals of the Ancient Keeper
        {4, 45439}, -- Unwavering Stare
        {5, 45325}, -- Gloves of the Stonereaper
        ...
        {9, "ac3182", nil, nil, AL["Hard Mode"]}, {10, 45888}, -- Bitter Cold Armguards
        {11, 45876}, -- Shiver
        ...
        [RAID25_DIFF] = {{1, 45453}, -- Winter's Icy Embrace
        {2, 45454}, -- Frost-bound Chain Bracers
        {3, 45452}, -- Frostplate Greaves
        {4, 45451}, -- Frozen Loop
        {5, 45450}, -- Northern Barrier
        {8, "ac3184", nil, nil, AL["Hard Mode"]}, {9, 45461}, -- Drape of Icy Intent
        ...
        {9, "ac3176", nil, nil, AL["Hard Mode"]}, {10, 45928}, -- Gauntlets of the Thunder God
        ...
        {20, "ac2971"}, {21, "ac2973"}, {22, "ac3176"}, {23, "ac2977"}, {24, "ac2975"}},
        [RAID25_DIFF] = {{1, 45468}, -- Leggings of Lost Love
        {2, 45467}, -- Belt of the Betrayed
        {3, 45469}, -- Sif's Promise
        {4, 45466}, -- Scale of Fates
        {5, 45463}, -- Vulmir, the Northern Tempest
        {8, "ac3183", nil, nil, AL["Hard Mode"]}, {9, 45473}, -- Embrace of the Gladiator
        ...
        {22, "ac2972"}, {23, "ac2974"}, {24, "ac3183"}, {25, "ac2978"}, {26, "ac2976"}}
    }, { -- UlduarFreya
        name = AL["Freya"],
        npcID = 32906,
        Level = 999,
        ...
        {9, "ac3179", nil, nil, AL["Hard Mode"]}, {10, 45943}, -- Gloves of Whispering Winds
        ...
        [RAID25_DIFF] = {{1, 45483}, -- Boots of the Servant
        {2, 45482}, -- Leggings of the Lifetender
        {3, 45481}, -- Gauntlets of Ruthless Reprisal
        {4, 45480}, -- Nymph Heart Charm
        {5, 45479}, -- The Lifebinder
        {8, "ac3187", nil, nil, AL["Hard Mode"]}, {9, 45486}, -- Drape of the Sullen Goddess
        ...
        {9, "ac3180", nil, nil, AL["Hard Mode"]}, {10, 45993}, -- Mimiron's Flight Goggles
        ...
        {20, "ac3180"}, {21, "ac3138"}, {22, "ac2989"}},
        [RAID25_DIFF] = {{1, 45493}, -- Asimov's Drape
        {2, 45492}, -- Malleable Steelweave Mantle
        {3, 45491}, -- Waistguard of the Creator
        {4, 45490}, -- Pandora's Plea
        {5, 45489}, -- Insanity's Grip
        {8, "ac3189", nil, nil, AL["Hard Mode"]}, {9, 45496}, -- Titanskin Cloak
        ...
        {16, "ac3181"}, {17, "ac2996"}, {25, "ac3181", nil, nil, AL["Hard Mode"]}, {26, 46032}, -- Drape of the Faceless General
                         {27, 46034}, -- Leggings of Profound Darkness
        {28, 46036}, -- Void Sabre
        {29, 46035}, -- Aesuga, Hand of the Ardent Champion
        {30, 46033} -- Tortured Earth
        },
        [RAID25_DIFF] = {{1, 45514}, -- Mantle of the Unknowing
        {2, 45508}, -- Belt of the Darkspeaker
        {3, 45512}, -- Grips of the Unbroken
        {4, 45504}, -- Darkcore Leggings
        {5, 45513}, -- Boots of the Forgotten Depths
        ...
        {15, 45511}, -- Scepter of Lost Souls
        {16, 45038}, -- Fragment of Val'anyr
        {18, "ac3188"}, {19, "ac2997"}, {25, "ac3188", nil, nil, AL["Hard Mode"]}, {26, 45520}, -- Handwraps of the Vigilant
        ...
        {12, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarYoggSaron10"}, {16, 45656}, -- Mantle of the Wayward Conqueror
                         {17, 45657}, -- Mantle of the Wayward Protector
        {18, 45658}, -- Mantle of the Wayward Vanquisher
        {22, "ac3158", nil, nil, AL["Hard Mode"]}, {23, 46068}, -- Amice of Inconceivable Horror
        ...
        {29, "ac3159", nil, nil, AL["Hard Mode"]}, {30, 46312} -- Vanquished Clutches of Yogg-Saron
        },
        [RAID25_DIFF] = {{1, 45529}, -- Shawl of Haunted Memories
        {2, 45532}, -- Cowl of Dark Whispers
        {3, 45523}, -- Garona's Guise
        {4, 45524}, -- Chestguard of Insidious Intent
        {5, 45531}, -- Chestguard of the Fallen God
        ...
        {9, 45527}, -- Soulscribe
        {10, 45521}, -- Earthshaper
        {12, "SPECIAL_ACHIEVEMENT", nil, AL["Achievements"], nil, "AC_UlduarYoggSaron25"}, {16, 45038}, -- Fragment of Val'anyr
        ...
        {22, "ac3163", nil, nil, AL["Hard Mode"]}, {23, 45537}, -- Treads of the False Oracle
        ...
        {29, "ac3164", nil, nil, AL["Hard Mode"]}, {30, 45693} -- Mimiron's Head
        }
    }, { -- Trash
        name = AL["Trash"],
        ExtraList = true,
        [RAID10_DIFF] = {{1, 45541}, -- Shroud of Alteration
        ...
        [RAID25_DIFF] = {{1, 45541}, -- Shroud of Alteration
        {2, 45549}, -- Grips of Chaos
        {3, 45547}, -- Relic Hunter's Cord
        {4, 45548}, -- Belt of the Sleeper
        {5, 45543}, -- Shoulders of Misfortune
        ...
        name = AL["Patterns"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 45089}, -- Plans: Battlelord's Plate Boots
...
data["TrialoftheCrusader"] = {
    ...
    items = {{ -- TrialoftheCrusader NorthrendBeasts
        ...
        {24, "ac3917"}, {25, "ac3918"}, {26, "ac3800"}}, { -- alli
        ...
        {26, "ac3916"}, {27, "ac3812"}, {28, "ac3816"}}, { -- alli
        ...
        [RAID10H_DIFF] = AtlasLoot:GetRetByFaction({ -- horde
            ...
            {1, "INV_Box_01", nil, format(AL["%s Attempts left"], "1-24"), nil},
            {
                2,
                47242,
                [ATLASLOOT_IT_AMOUNT1] = 2
            }, -- Trophy of the Crusade
            {17, 47556}, -- Crusader Orb
            {3, "INV_Box_01", nil, format(AL["%s Attempts left"], "25-44"),
             format(AL["Includes the loot from %s"], "1-24")},
            ...
            {20, 48705}, -- Attrition
            {21, 48695}, -- Mor'kosh
            {8, "INV_Box_01", nil, format(AL["%s Attempts left"], "45-49"),
             format(AL["Includes the loot from %s"], "1-44")},
            {
                9,
                47242,
                [ATLASLOOT_IT_AMOUNT1] = 2
            }, -- Trophy of the Crusade
            {10, "INV_Box_01", nil, format(AL["%s Attempts left"], "50"),
             format(AL["Includes the loot from %s"], "1-49")},
        ...
        [RAID25H_DIFF] = AtlasLoot:GetRetByFaction({ -- horde
            ...
            {4, "INV_Box_01", nil, format(AL["%s Attempts left"], "25-44"),
             format(AL["Includes the loot from %s"], "1-24")},
...
data["WrathOnyxiasLair"] = {
    ...
    items = {{ -- Onyxia
        ...
        {27, "ac4396"}, {28, "ac4403"}, {29, "ac4402"}, {30, "ac4404"}},
        [RAID25_DIFF] = {{1, "SLOT_HEAD", nil, AL["Class Item drops"], nil, "WrathOnyxiaClassItems25"}, {2, 49491}, -- Fluttering Sapphiron Drape
        ...
        {22, 49295}, -- Enlarged Onyxia Hide Backpack
        {23, 49294}, -- Ashen Sack of Gems
        {27, "ac4397"}, {28, "ac4406"}, {29, "ac4405"}, {30, "ac4407"}}
    }, T9_SET}
}
...
data["IcecrownCitadel"] = {
    ...
    items = {{ -- ICC LordMarrowgar
        ...
        {21, "ac4534"}},
        [RAID10H_DIFF] = {{1, 51933}, -- Shawl of Nerubian Silk
        ...
        {23, "ac4534"}},
        [RAID25_DIFF] = {{1, 49978}, -- Crushing Coldwraith Belt
        ...
        {21, 49908}, -- Primordial Saronite
        {23, "ac4610"}},
        [RAID25H_DIFF] = {{1, 50613}, -- Crushing Coldwraith Belt
        ...
        {21, "ac4535"}},
        [RAID10H_DIFF] = {{1, 51918}, -- Bracers of Dark Blessings
        ...
        {21, 49908}, -- Primordial Saronite
        {23, "ac4535"}},
        [RAID25_DIFF] = {{1, 49991}, -- Shoulders of Mercy Killing
        ...
        {21, 49908}, -- Primordial Saronite
        {23, "ac4611"}},
        [RAID25H_DIFF] = {{1, 50643}, -- Shoulders of Mercy Killing
        ...
        {20, "ac4536"}},
        [RAID10H_DIFF] = {{1, 51912}, -- Saronite Gargoyle Cloak
        ...
        {22, "ac4536"}},
        [RAID25_DIFF] = {{1, 49998}, -- Shadowvault Slayer's Cloak
        ...
        {24, "ac4612"}},
        [RAID25H_DIFF] = {{1, 50653}, -- Shadowvault Slayer's Cloak
        ...
        {22, "ac4537"}},
        [RAID10H_DIFF] = {{1, 51896}, -- Thaumaturge's Crackling Cowl
        ...
        {25, "ac4537"}},
        [RAID25_DIFF] = {{1, 50014}, -- Greatcloak of the Turned Champion
        ...
        {18, 52025}, -- Vanquisher's Mark of Sanctification
        {20, "ac4613"}},
        [RAID25H_DIFF] = {{1, 50668}, -- Greatcloak of the Turned Champion
        ...
        {22, "ac4577"}},
        [RAID10H_DIFF] = {{1, 51888}, -- Cloak of Many Skins
        ...
        {24, "ac4577"}},
        [RAID25_DIFF] = {{1, 50063}, -- Lingering Illness
        ...
        {27, "ac4615"}},
        [RAID25H_DIFF] = {{1, 50702}, -- Lingering Illness
        ...
        {20, "ac4538"}},
        [RAID10H_DIFF] = {{1, 51872}, -- Ether-Soaked Bracers
        ...
        {20, 49908}, -- Primordial Saronite
        {22, "ac4538"}},
        [RAID25_DIFF] = {{1, 50019}, -- Winding Sheet
        ...
        {23, 49908}, -- Primordial Saronite
        {25, "ac4614"}},
        [RAID25H_DIFF] = {{1, 50677}, -- Winding Sheet
        ...
        {23, "ac4578"}},
        [RAID10H_DIFF] = {{1, 51859}, -- Shoulders of Ruinous Senility
        ...
        {23, 49908}, -- Primordial Saronite
        {25, "ac4578"}},
        [RAID25_DIFF] = {{1, 50067}, -- Astrylian's Sutured Cinch
        ...
        {18, 52025}, -- Vanquisher's Mark of Sanctification
        {20, "ac4616"}},
        [RAID25H_DIFF] = {{1, 50707}, -- Astrylian's Sutured Cinch
        ...
        {20, "ac4582"}},
        [RAID10H_DIFF] = {{1, 51848}, -- Heartsick Mender's Cape
        ...
        {20, 49908}, -- Primordial Saronite
        {22, "ac4582"}},
        [RAID25_DIFF] = {{1, 50074}, -- Royal Crimson Cloak
        ...
        {26, "ac4617"}},
        [RAID25H_DIFF] = {{1, 50718}, -- Royal Crimson Cloak
        ...
        {23, "ac4539"}},
        [RAID10H_DIFF] = {{1, 51837}, -- Cowl of Malefic Repose
        ...
        {24, 49908}, -- Primordial Saronite
        {26, "ac4539"}},
        [RAID25_DIFF] = {{1, 50182}, -- Blood Queen's Crimson Choker
        ...
        {18, 52025}, -- Vanquisher's Mark of Sanctification
        {20, "ac4618"}},
        [RAID25H_DIFF] = {{1, 50724}, -- Blood Queen's Crimson Choker
        ...
        {20, "ac4579"}},
        [RAID10H_DIFF] = {{1, 51826}, -- Lich Wrappings
        ...
        {20, 49908}, -- Primordial Saronite
        {22, "ac4579"}},
        [RAID25_DIFF] = {{1, 50205}, -- Frostbinder's Shredded Cape
        ...
        {24, 49908}, -- Primordial Saronite
        {26, "ac4619"}},
        [RAID25H_DIFF] = {{1, 50628}, -- Frostbinder's Shredded Cape
        ...
        {22, "ac4580"}},
        [RAID10H_DIFF] = {{1, 51813}, -- Robes of Azure Downfall
        ...
        {24, 49908}, -- Primordial Saronite
        {26, "ac4580"}},
        [RAID25_DIFF] = {{1, 50421}, -- Sindragosa's Cruel Claw
        ...
        {18, 52025}, -- Vanquisher's Mark of Sanctification
        {20, "ac4620"}},
        [RAID25H_DIFF] = {{1, 50633}, -- Sindragosa's Cruel Claw
        ...
        {16, "ac4530"}, {17, "ac4601"}, {18, "ac4581"}},
        [RAID10H_DIFF] = {{1, 51941}, -- Pugius, Fist of Defiance
        ...
        {18, 52025}, -- Vanquisher's Mark of Sanctification
        {20, 49908}, -- Primordial Saronite
        {22, "ac4583"}, {23, "ac4601"}, {24, "ac4581"}},
        [RAID25_DIFF] = {{1, 50426}, -- Heaven's Fall, Kryss of a Thousand Lies
        ...
        {20, 50274}, -- Shadowfrost Shard
        {21, 49908}, -- Primordial Saronite
        {23, "ac4597"}, {24, "ac4621"}, {25, "ac4622"}},
        [RAID25H_DIFF] = {{1, 50736}, -- Heaven's Fall, Kryss of a Thousand Lies
        ...
        {21, 52026}, -- Protector's Mark of Sanctification
        {22, 52025}, -- Vanquisher's Mark of Sanctification
        {25, "ac4584"}, {26, "ac4621"}, {27, "ac4622"}}
    }, { -- ICC Trash
        name = AL["Trash Mobs"],
        ExtraList = true,
        [RAID25_DIFF] = {{1, 50449}, -- Stiffened Corpse Shoulderpads
...
data["RubySanctum"] = {
    ...
    items = {{ -- Halion
        ...
        {20, "ac4817"}},
        [RAID10H_DIFF] = {{1, 54556}, -- Abduction's Cover
        ...
        {20, "ac4818"}},
        [RAID25_DIFF] = {{1, 53489}, -- Cloak of Burning Dusk
        ...
        {24, "ac4815"}},
        [RAID25H_DIFF] = {{1, 54583}, -- Cloak of Burning Dusk
...
data["VaultofArchavon"] = {
    ...
    items = {{ -- VaultofArchavonArchavon
        ...
        [RAID25_DIFF] = {{1, "CLASS_WARLOCK", nil, CLASS_NAME["WARLOCK"], nil, "VoA_A_WARLOCK_25"},
        ...
        [RAID25_DIFF] = {{1, "CLASS_WARLOCK", nil, CLASS_NAME["WARLOCK"], nil, "VoA_E_WARLOCK_25"},
        ...
        [RAID10_DIFF] = {{1, "CLASS_WARLOCK", nil, CLASS_NAME["WARLOCK"], nil,
                         ...
                         {3, "CLASS_PRIEST", nil, CLASS_NAME["PRIEST"], AL["Holy"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PRIEST_10_H", "VoA_KA_PRIEST_10_H")},
                         {4, "CLASS_PRIEST", nil, CLASS_NAME["PRIEST"], AL["Shadow"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PRIEST_10_D", "VoA_KA_PRIEST_10_D")},
                         {6, "CLASS_ROGUE", nil, CLASS_NAME["ROGUE"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_ROGUE_10", "VoA_KA_ROGUE_10")},
                         {8, "CLASS_HUNTER", nil, CLASS_NAME["HUNTER"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_HUNTER_10", "VoA_KA_HUNTER_10")},
                         {10, "CLASS_WARRIOR", nil, CLASS_NAME["WARRIOR"], AL["Protection"],
                          AtlasLoot:GetRetByFaction("VoA_KH_WARRIOR_10_T", "VoA_KA_WARRIOR_10_T")},
                         {11, "CLASS_WARRIOR", nil, CLASS_NAME["WARRIOR"], ROLE_DD,
                          AtlasLoot:GetRetByFaction("VoA_KH_WARRIOR_10_D", "VoA_KA_WARRIOR_10_D")},
                         {13, "CLASS_DEATHKNIGHT", nil, CLASS_NAME["DEATHKNIGHT"], AL["Blood"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DEATHKNIGHT_10_T", "VoA_KA_DEATHKNIGHT_10_T")},
                         {14, "CLASS_DEATHKNIGHT", nil, CLASS_NAME["DEATHKNIGHT"], ROLE_DD,
                          AtlasLoot:GetRetByFaction("VoA_KH_DEATHKNIGHT_10_D", "VoA_KA_DEATHKNIGHT_10_D")},
                         {16, "CLASS_MAGE", nil, CLASS_NAME["MAGE"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_MAGE_10", "VoA_KA_MAGE_10")},
                         {18, "CLASS_DRUID", nil, CLASS_NAME["DRUID"], AL["Restoration"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DRUID_10_H", "VoA_KA_DRUID_10_H")},
                         {19, "CLASS_DRUID", nil, CLASS_NAME["DRUID"], AL["Balance"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DRUID_10_DR", "VoA_KA_DRUID_10_DR")},
                         {20, "CLASS_DRUID", nil, CLASS_NAME["DRUID"], AL["Feral"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DRUID_10_D", "VoA_KA_DRUID_10_D")},
                         {22, "CLASS_SHAMAN", nil, CLASS_NAME["SHAMAN"], AL["Restoration"],
                          AtlasLoot:GetRetByFaction("VoA_KH_SHAMAN_10_H", "VoA_KA_SHAMAN_10_H")},
                         {23, "CLASS_SHAMAN", nil, CLASS_NAME["SHAMAN"], AL["Elemental"],
                          AtlasLoot:GetRetByFaction("VoA_KH_SHAMAN_10_DR", "VoA_KA_SHAMAN_10_DR")},
                         {24, "CLASS_SHAMAN", nil, CLASS_NAME["SHAMAN"], AL["Enhancement"],
                          AtlasLoot:GetRetByFaction("VoA_KH_SHAMAN_10_D", "VoA_KA_SHAMAN_10_D")},
                         {26, "CLASS_PALADIN", nil, CLASS_NAME["PALADIN"], AL["Protection"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PALADIN_10_T", "VoA_KA_PALADIN_10_T")},
                         {27, "CLASS_PALADIN", nil, CLASS_NAME["PALADIN"], AL["Holy"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PALADIN_10_H", "VoA_KA_PALADIN_10_H")},
                         {28, "CLASS_PALADIN", nil, CLASS_NAME["PALADIN"], AL["Retribution"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PALADIN_10_D", "VoA_KA_PALADIN_10_D")},
        ...
        [RAID25_DIFF] = {{1, "CLASS_WARLOCK", nil, CLASS_NAME["WARLOCK"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_WARLOCK_25", "VoA_KA_WARLOCK_25")},
                         {3, "CLASS_PRIEST", nil, CLASS_NAME["PRIEST"], AL["Holy"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PRIEST_25_H", "VoA_KA_PRIEST_25_H")},
                         {4, "CLASS_PRIEST", nil, CLASS_NAME["PRIEST"], AL["Shadow"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PRIEST_25_D", "VoA_KA_PRIEST_25_D")},
                         {6, "CLASS_ROGUE", nil, CLASS_NAME["ROGUE"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_ROGUE_25", "VoA_KA_ROGUE_25")},
                         {8, "CLASS_HUNTER", nil, CLASS_NAME["HUNTER"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_HUNTER_25", "VoA_KA_HUNTER_25")},
                         {10, "CLASS_WARRIOR", nil, CLASS_NAME["WARRIOR"], AL["Protection"],
                          AtlasLoot:GetRetByFaction("VoA_KH_WARRIOR_25_T", "VoA_KA_WARRIOR_25_T")},
                         {11, "CLASS_WARRIOR", nil, CLASS_NAME["WARRIOR"], ROLE_DD,
                          AtlasLoot:GetRetByFaction("VoA_KH_WARRIOR_25_D", "VoA_KA_WARRIOR_25_D")},
                         {13, "CLASS_DEATHKNIGHT", nil, CLASS_NAME["DEATHKNIGHT"], AL["Blood"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DEATHKNIGHT_25_T", "VoA_KA_DEATHKNIGHT_25_T")},
                         {14, "CLASS_DEATHKNIGHT", nil, CLASS_NAME["DEATHKNIGHT"], ROLE_DD,
                          AtlasLoot:GetRetByFaction("VoA_KH_DEATHKNIGHT_25_D", "VoA_KA_DEATHKNIGHT_25_D")},
                         {16, "CLASS_MAGE", nil, CLASS_NAME["MAGE"], nil,
                          AtlasLoot:GetRetByFaction("VoA_KH_MAGE_25", "VoA_KA_MAGE_25")},
                         {18, "CLASS_DRUID", nil, CLASS_NAME["DRUID"], AL["Restoration"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DRUID_25_H", "VoA_KA_DRUID_25_H")},
                         {19, "CLASS_DRUID", nil, CLASS_NAME["DRUID"], AL["Balance"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DRUID_25_DR", "VoA_KA_DRUID_25_DR")},
                         {20, "CLASS_DRUID", nil, CLASS_NAME["DRUID"], AL["Feral"],
                          AtlasLoot:GetRetByFaction("VoA_KH_DRUID_25_D", "VoA_KA_DRUID_25_D")},
                         {22, "CLASS_SHAMAN", nil, CLASS_NAME["SHAMAN"], AL["Restoration"],
                          AtlasLoot:GetRetByFaction("VoA_KH_SHAMAN_25_H", "VoA_KA_SHAMAN_25_H")},
                         {23, "CLASS_SHAMAN", nil, CLASS_NAME["SHAMAN"], AL["Elemental"],
                          AtlasLoot:GetRetByFaction("VoA_KH_SHAMAN_25_DR", "VoA_KA_SHAMAN_25_DR")},
                         {24, "CLASS_SHAMAN", nil, CLASS_NAME["SHAMAN"], AL["Enhancement"],
                          AtlasLoot:GetRetByFaction("VoA_KH_SHAMAN_25_D", "VoA_KA_SHAMAN_25_D")},
                         {26, "CLASS_PALADIN", nil, CLASS_NAME["PALADIN"], AL["Protection"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PALADIN_25_T", "VoA_KA_PALADIN_25_T")},
                         {27, "CLASS_PALADIN", nil, CLASS_NAME["PALADIN"], AL["Holy"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PALADIN_25_H", "VoA_KA_PALADIN_25_H")},
                         {28, "CLASS_PALADIN", nil, CLASS_NAME["PALADIN"], AL["Retribution"],
                          AtlasLoot:GetRetByFaction("VoA_KH_PALADIN_25_D", "VoA_KA_PALADIN_25_D")},
        ...
        [RAID25_DIFF] = {{1, "CLASS_WARLOCK", nil, CLASS_NAME["WARLOCK"], nil, "VoA_T_WARLOCK_25"},
