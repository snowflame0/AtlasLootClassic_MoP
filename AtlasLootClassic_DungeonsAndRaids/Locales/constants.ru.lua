...
-- Blackrock Caverns
AL["Rom'ogg Bonecrusher"] = "Ром'огг Костекрушитель"
AL["Corla, Herald of Twilight"] = "Глашатай сумрака Корла"
AL["Karsh Steelbender"] = "Карш Гнущий Сталь"
AL["Beauty"] = "Красавица"
AL["Ascendant Lord Obsidius"] = "Повелитель Перерожденных Обсидий"
-- Deadmines
AL["Glubtok"] = "Глубток"
AL["Helix Gearbreaker"] = "Хеликс Отломчикс"
AL["Foe Reaper 5000"] = "Врагорез-5000"
AL["Admiral Ripsnarl"] = "Адмирал Терзающий Рев"
AL["\"Captain\" Cookie"] = "\"Капитан\" Пирожок"
AL["Vanessa VanCleef"] = "Ванесса ван Клиф"
-- Grim Batol
AL["General Umbriss"] = "Генерал Умбрисс"
AL["Forgemaster Throngus"] = "Начальник кузни Тронг"
AL["Drahga Shadowburner"] = "Драгх Горячий Мрак"
AL["Erudax, the Duke of Below"] = "Эрудакс, властитель недр"
-- Halls of Origination
AL["Temple Guardian Anhuur"] = "Храмовый страж Ануур"
AL["Earthrager Ptah"] = "Пта Ярость Земли"
AL["Anraphet"] = "Анрафет"
AL["Isiset, Construct of Magic"] = "Изисет, творение Магии"
AL["Ammunae, Construct of Life"] = "Аммунаэ, творение Жизни"
AL["Setesh, Construct of Destruction"] = "Сетеш, творение Разрушения"
AL["Rajh, Construct of Sun"] = "Радж, творение Солнца"
-- Lost City of the Tol'vir
AL["General Husam"] = "Генерал Хусам"
AL["Lockmaw"] = "Зубохлоп"
AL["High Prophet Barim"] = "Верховный пророк Барим"
AL["Siamat"] = "Сиамат"
-- Shadowfang Keep
AL["Baron Ashbury"] = "Барон Эшбери"
AL["Baron Silverlaine"] = "Барон Сильверлейн"
AL["Commander Springvale"] = "Командир Спрингвейл"
AL["Lord Walden"] = "Лорд Вальден"
AL["Lord Godfrey"] = "Лорд Годфри"
-- The Stonecore
AL["Corborus"] = "Корбор"
AL["Slabhide"] = "Камнешкур"
AL["Ozruk"] = "Озрук"
AL["High Priestess Azil"] = "Верховная жрица Азил"
-- The Vortex Pinnacle
AL["Grand Vizier Ertan"] = "Великий визирь Эртан"
AL["Altairus"] = "Альтаирий"
AL["Asaad, Caliph of Zephyrs"] = "Асаад, калиф зефиров"
-- The Throne of the Tides
AL["Lady Naz'jar"] = "Леди Наз'жар"
AL["Commander Ulthok, the Festering Prince"] = "Командир Улток, разлагающийся принц"
AL["Mindbender Ghur'sha"] = "Подчиняющий разум Гур'ша"
AL["Ozumat"] = "Озумат"
-- Zul'Aman
AL["Akil'zon"] = "Акил'зон"
AL["Nalorakk"] = "Налоракк"
...
AL["Hex Lord Malacrass"] = "Повелитель проклятий Малакрасс"
AL["Daakara"] = "Даакара"
AL["Timed Reward Chest"] = "Сундук на время"
-- Zul'Gurub
AL["High Priest Venoxis"] = "Верховный жрец Веноксис"
AL["Bloodlord Mandokir"] = "Мандокир Повелитель Крови"
AL["Gri'lek"] = "Гри'лек"
...
AL["Renataki"] = "Ренатаки"
AL["Wushoolay"] = "Вушулай"
AL["High Priestess Kilnara"] = "Верховная жрица Килнара"
AL["Zanzil"] = "Занзил"
AL["Jin'do the Godbreaker"] = "Джин'до Низвергатель Богов"
-- End of Time
AL["Echo of Baine"] = "Эхо Бейна"
AL["Echo of Jaina"] = "Эхо Джайны"
AL["Echo of Tyrande"] = "Эхо Тиранды"
AL["Echo of Sylvanas"] = "Эхо Сильваны"
AL["Murozond"] = "Дорнозму"
-- Well of Eternity
AL["Peroth'arn"] = "Перот'арн"
AL["Queen Azshara"] = "Королева Азшара"
AL["Mannoroth and Varo'then"] = "Маннорот и Варо'тен"
-- Hour of Twilight
AL["Arcurion"] = "Аркурион"
AL["Asira Dawnslayer"] = "Азира Убийца Зари"
AL["Archbishop Benedictus"] = "Архиепископ Бенедикт"
-- Baradin Hold
AL["Argaloth"] = "Аргалот"
AL["Occu'thar"] = "Оку'тар"
AL["Alizabal, Mistress of Hate"] = "Ализабаль"
-- The Bastion of Twilight
AL["Halfus Wyrmbreaker"] = "Халфий Змеерез"
AL["Theralion and Valiona"] = "Тералион и Валиона"
AL["Ascendant Council"] = "Совет Перерожденных"
AL["Cho'gall"] = "Чо'Галл"
AL["Sinestra"] = "Синестра"
-- Blackwing Descent
AL["Omnotron Defense System"] = "Защитная система \"Омнитрон\""
AL["Magmaw"] = "Магмарь"
AL["Atramedes"] = "Атрамед"
AL["Chimaeron"] = "Химерон"
AL["Maloriak"] = "Малориак"
AL["Nefarian's End"] = "Гибель Нефариана"
-- Throne of the Four Winds
AL["The Conclave of Wind"] = "Трон Четырех Ветров"
AL["Al'Akir"] = "Ал'акир"
-- Firelands
AL["Beth'tilac"] = "Бет'тилак"
AL["Lord Rhyolith"] = "Повелитель Риолит"
AL["Alysrazor"] = "Алисразор"
AL["Shannox"] = "Шэннокс"
AL["Baleroc, the Gatekeeper"] = "Бейлрок, привратник"
AL["Majordomo Staghelm"] = "Мажордом Фэндрал Олений Шлем"
AL["Ragnaros"] = "Рагнарос"
AL["Firestone Vendor"] = "Лура Гневная Лоза <Собиратель кристаллизованного кремня>"
-- Dragon Soul
AL["Morchok"] = "Морхок"
AL["Warlord Zon'ozz"] = "Полководец Зон'озз"
AL["Yor'sahj the Unsleeping"] = "Йор'садж Неспящий"
AL["Hagara the Stormbinder"] = "Хагара Владычица Штормов"
AL["Ultraxion"] = "Ультраксион"
AL["Warmaster Blackhorn"] = "Воевода Черный Рог"
AL["Spine of Deathwing"] = "Хребет Смертокрыла"
AL["Madness of Deathwing"] = "Безумие Смертокрыла"