...
data["PvPMountsWrath"] = {
    ...
    items = {{ -- PvPMountsPvP
        name = ALIL["Mounts"],
        [ALLIANCE_DIFF] = {{1, 19030}, -- Stormpike Battle Charger
        ...
        [HORDE_DIFF] = {{1, 19029}, -- Horn of the Frostwolf Howler
...
data["ArenaS5PvP"] = {
    ...
    items = {{
        ...
        [SET1_DIFF] = {{1, 42216}, -- Savage Gladiator's Shanker
        ...
        [SET2_DIFF] = {{1, 42241}, -- Hateful Gladiator's Shanker
        ...
        [SET3_DIFF] = {{1, 42242}, -- Deadly Gladiator's Shanker
        ...
        [SET1_DIFF] = {{1, 42297}, -- Savage Gladiator's Greatsword
        ...
        [SET2_DIFF] = {{1, 42331}, -- Hateful Gladiator's Greatsword
        ...
        [SET3_DIFF] = {{1, 42332}, -- Deadly Gladiator's Greatsword
        ...
        [SET1_DIFF] = {{1, 42445}, -- Savage Gladiator's Longbow
        ...
        [SET2_DIFF] = {{1, 42489}, -- Hateful Gladiator's Longbow
        ...
        [SET3_DIFF] = {{1, 42490}, -- Deadly Gladiator's Longbow
        ...
        [SET3_DIFF] = {{1, 42068}, -- Deadly Gladiator's Cloak of Victory
        ...
        name = ALIL["Relic"],
        [SET1_DIFF] = {{1, 42575}, -- Savage Gladiator's Idol of Steadfastness
        ...
        [SET2_DIFF] = {{1, 42582}, -- Hateful Gladiator's Idol of Steadfastness
        ...
        [SET3_DIFF] = {{1, 42583}, -- Deadly Gladiator's Idol of Steadfastness
        ...
        name = ALIL["Neck"],
        [SET2_DIFF] = {{1, 42021}, -- Hateful Gladiator's Pendant of Victory
        ...
        [SET3_DIFF] = {{1, 42028}, -- Deadly Gladiator's Pendant of Victory
        ...
        name = ALIL["Finger"],
        [SET2_DIFF] = {{1, 42112}, -- Hateful Gladiator's Band of Triumph
        {16, 42110} -- Hateful Gladiator's Band of Dominance
        },
        [SET3_DIFF] = {{1, 42115}, -- Deadly Gladiator's Band of Victory
        {16, 42114} -- Deadly Gladiator's Band of Ascendancy
        }
    }, {
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 41879}, -- Hateful Gladiator's Slippers of Salvation
        ...
        [NORMAL_DIFF] = {{1, 41331}, -- Hateful Gladiator's Boots of Salvation
        ...
        [NORMAL_DIFF] = {{1, 41049}, -- Hateful Gladiator's Sabatons of Salvation
        ...
        [NORMAL_DIFF] = {{1, 40878}, -- Hateful Gladiator's Greaves of Triumph
...
data["ArenaS6PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 42243}, -- Furious Gladiator's Shanker
        ...
        [NORMAL_DIFF] = {{1, 45958}, -- Furious Gladiator's Spike
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 42333}, -- Furious Gladiator's Greatsword
        ...
        [NORMAL_DIFF] = {{1, 45950}, -- Furious Gladiator's Claymore
        ...
        name = AL["Weapons"] .. " - " .. AL["Ranged"],
        [NORMAL_DIFF] = {{1, 42491}, -- Furious Gladiator's Longbow
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 42584}, -- Furious Gladiator's Idol of Steadfastness
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 42035}, -- Furious Gladiator's Pendant of Victory
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 42117}, -- Furious Gladiator's Band of Triumph
        {16, 42116} -- Furious Gladiator's Band of Dominance
        }
    }, {
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 41885}, -- Furious Gladiator's Slippers of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Leather"]),
        [NORMAL_DIFF] = {{1, 41621}, -- Furious Gladiator's Boots of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Mail"]),
        [NORMAL_DIFF] = {{1, 41055}, -- Furious Gladiator's Sabatons of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Plate"]),
        [NORMAL_DIFF] = {{1, 40882}, -- Furious Gladiator's Greaves of Triumph
        ...
        name = AL["Gladiator Mount"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 46171} -- Furious Gladiator's Frost Wyrm
        }
    }}
}
...
data["ArenaS7PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 42244}, -- Relentless Gladiator's Shanker
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"] .. " - R2",
        [NORMAL_DIFF] = {{1, 48509}, -- Relentless Gladiator's Spike
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 42334}, -- Relentless Gladiator's Greatsword
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"] .. " - R2",
        [NORMAL_DIFF] = {{1, 48406}, -- Relentless Gladiator's Claymore
        ...
        name = AL["Weapons"] .. " - " .. AL["Ranged"],
        [NORMAL_DIFF] = {{1, 42492}, -- Relentless Gladiator's Longbow
        ...
        name = AL["Weapons"] .. " - " .. AL["Ranged"] .. " - R2",
        [NORMAL_DIFF] = {{1, 48420}, -- Relentless Gladiator's Recurve
        {3, 48422}, -- Relentless Gladiator's Repeater
        {5, 48424} -- Relentless Gladiator's Shotgun
        }
    }, {
        name = AL["Weapons"] .. " - " .. ALIL["Off Hand"],
        [SET1_DIFF] = {{1, 42527}, -- Relentless Gladiator's Endgame
        ...
        name = AL["Weapons"] .. " - " .. ALIL["Shields"],
        [NORMAL_DIFF] = {{1, 42561}, -- Relentless Gladiator's Shield Wall
        {16, 42572}, -- Relentless Gladiator's Redoubt
        {17, 42566} -- Relentless Gladiator's Barrier
        }
    }, {
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 42082}, -- Relentless Gladiator's Cloak of Victory
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 42585}, -- Relentless Gladiator's Idol of Steadfastness
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 42042}, -- Relentless Gladiator's Pendant of Victory
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 42118}, -- Relentless Gladiator's Band of Ascendancy
        {16, 42119} -- Relentless Gladiator's Band of Victory
        }
    }, {
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 41886}, -- Relentless Gladiator's Slippers of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Leather"]),
        [NORMAL_DIFF] = {{1, 41622}, -- Relentless Gladiator's Boots of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Mail"]),
        [NORMAL_DIFF] = {{1, 41056}, -- Relentless Gladiator's Sabatons of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Plate"]),
        [NORMAL_DIFF] = {{1, 40884}, -- Relentless Gladiator's Greaves of Triumph
        ...
        name = AL["Gladiator Mount"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 47840} -- Relentless Gladiator's Frost Wyrm
        }
    }}
}
...
data["ArenaS8PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 51517}, -- Wrathful Gladiator's Shanker
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"] .. " - R2",
        [NORMAL_DIFF] = {{1, 51518}, -- Wrathful Gladiator's Spike
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 51392}, -- Wrathful Gladiator's Greatsword
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"] .. " - R2",
        [NORMAL_DIFF] = {{1, 51393}, -- Wrathful Gladiator's Claymore
        ...
        name = AL["Weapons"] .. " - " .. AL["Ranged"],
        [NORMAL_DIFF] = {{1, 51394}, -- Wrathful Gladiator's Longbow
        ...
        name = AL["Weapons"] .. " - " .. AL["Ranged"] .. " - R2",
        [NORMAL_DIFF] = {{1, 51395}, -- Wrathful Gladiator's Recurve
        {3, 51412}, -- Wrathful Gladiator's Repeater
        {5, 51450} -- Wrathful Gladiator's Shotgun
        }
    }, {
        name = AL["Weapons"] .. " - " .. ALIL["Off Hand"],
        [SET1_DIFF] = {{1, 51396}, -- Wrathful Gladiator's Endgame
        ...
        name = AL["Weapons"] .. " - " .. ALIL["Shields"],
        [NORMAL_DIFF] = {{1, 51533}, -- Wrathful Gladiator's Shield Wall
        {16, 51455}, -- Wrathful Gladiator's Redoubt
        {17, 51452} -- Wrathful Gladiator's Barrier
        }
    }, {
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 51356}, -- Wrathful Gladiator's Cloak of Victory
        ...
        name = ALIL["Relic"],
        [NORMAL_DIFF] = {{1, 51437}, -- Wrathful Gladiator's Idol of Steadfastness
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 51357}, -- Wrathful Gladiator's Pendant of Victory
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 51358}, -- Wrathful Gladiator's Band of Triumph
        {16, 51336} -- Wrathful Gladiator's Band of Dominance
        }
    }, {
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 51366}, -- Wrathful Gladiator's Slippers of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Leather"]),
        [NORMAL_DIFF] = {{1, 51341}, -- Wrathful Gladiator's Boots of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Mail"]),
        [NORMAL_DIFF] = {{1, 51372}, -- Wrathful Gladiator's Sabatons of Salvation
        ...
        name = format(AL["Non Set '%s'"], ALIL["Plate"]),
        [NORMAL_DIFF] = {{1, 51363}, -- Wrathful Gladiator's Greaves of Triumph
        ...
        name = AL["Gladiator Mount"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 50435} -- Wrathful Gladiator's Frost Wyrm
        }
    }}
}
...
data["Wintergrasp"] = {
    ...
    items = {{
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 51570}, -- Titan-Forged Cloak of Ascendancy
        {2, 51571} -- Titan-Forged Cloak of Victory
        }
    }, {
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 51568}, -- Titan-Forged Pendant of Ascendancy
        {2, 51569} -- Titan-Forged Pendant of Victory
        }
    }, {
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 48999}, -- Titan-Forged Band of Ascendancy
        {2, 49000} -- Titan-Forged Band of Victory
        }
    }, {
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 44914}, -- Anvil of Titans
        ...
        name = ALIL["Cloth"],
        [NORMAL_DIFF] = {{1, 44910}, -- Titan-Forged Hood of Dominance
        ...
        name = ALIL["Leather"],
        [NORMAL_DIFF] = {{1, 44907}, -- Titan-Forged Leather Helm of Dominance
        ...
        name = ALIL["Mail"],
        [NORMAL_DIFF] = {{1, 44904}, -- Titan-Forged Mail Helm of Dominance
        ...
        name = ALIL["Plate"],
        [NORMAL_DIFF] = {{1, 44901}, -- Titan-Forged Plate Headcover of Salvation
        ...
        name = ALIL["Gems"],
        [NORMAL_DIFF] = {{1, 44066}, -- Kharmaa's Grace
        ...
        [NORMAL_DIFF] = {{1, 44075}, -- Arcanum of Dominance
        ...
        name = AL["Recipe"],
        [NORMAL_DIFF] = {{1, 41730}, -- Design: Durable Monarch Topaz
        ...
        name = AL["Heirloom"],
        [NORMAL_DIFF] = {{1, 44107}, -- Exquisite Sunderseer Mantle
        ...
        name = ALIL["Mounts"],
        [NORMAL_DIFF] = {{1, AtlasLoot:GetRetByFaction(44077, 43956)} -- Reins of the Black War Mammoth
        }
    }}
}
