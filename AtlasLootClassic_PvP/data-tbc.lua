...
if AtlasLoot:GameVersion_LT(AtlasLoot.BC_VERSION_NUM) then
    return
end
...
local PVP_INSIGNIA = { -- Insignias
    ...
    [ALLIANCE_DIFF] = {{
        1,
        25829,
        [PRICE_EXTRA_ITTYPE] = "honorA:22950:pvpEye:10"
    }, -- Talisman of the Alliance
    {
        2,
        37864,
        [PRICE_EXTRA_ITTYPE] = "honorA:40000"
    }, -- Medallion of the Alliance
    {
        3,
        28235,
        [PRICE_EXTRA_ITTYPE] = "honorA:8000"
    }, -- Medallion of the Alliance
    {
        4,
        28237,
    ...
    [HORDE_DIFF] = {{
        1,
        24551,
        [PRICE_EXTRA_ITTYPE] = "honorH:22950:pvpEye:10"
    }, -- Talisman of the Horde
    {
        2,
        37865,
        [PRICE_EXTRA_ITTYPE] = "honorH:40000"
    }, -- Medallion of the Horde
    {
        3,
        28241,
        [PRICE_EXTRA_ITTYPE] = "honorH:8000"
    }, -- Medallion of the Horde
    {
        4,
        28243,
...
data["HonorSetBCC"] = {
    ...
    items = {{
        ...
        [ALLIANCE_DIFF] = {{1, 28954}, -- Grand Marshal's Shanker
        ...
        [HORDE_DIFF] = {{1, 28929}, -- High Warlord's Shanker
        ...
        [ALLIANCE_DIFF] = {{1, 28943}, -- Grand Marshal's Warblade
        ...
        [HORDE_DIFF] = {{1, 28293}, -- High Warlord's Claymore
        ...
        [ALLIANCE_DIFF] = {{1, 28960} -- Grand Marshal's Heavy Crossbow
        },
        [HORDE_DIFF] = {{1, 28933} -- High Warlord's Heavy Crossbow
        }
    }, {
        name = AL["Weapons"] .. " - " .. ALIL["Off Hand"],
        [ALLIANCE_DIFF] = {{1, 28940}, -- Grand Marshal's Barricade
        {16, 28941} -- Grand Marshal's Battletome
        },
        [HORDE_DIFF] = {{1, 28939}, -- High Warlord's Barricade
        {16, 28938} -- High Warlord's Battletome
        }
    }, {
        name = ALIL["Cloak"],
        [ALLIANCE_DIFF] = {{1, 28377}, -- Sergeant's Heavy Cloak
        {2, 28378} -- Sergeant's Heavy Cape
        },
        [HORDE_DIFF] = {{1, 28377}, -- Sergeant's Heavy Cloak
        {2, 28378} -- Sergeant's Heavy Cape
        }
    }, PVP_INSIGNIA, PVP_GEMS}
}
...
data["ArenaS1PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 28312}, -- Gladiator's Shanker
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 24550}, -- Gladiator's Greatsword
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 28244}, -- Pendant of Triumph
        {2, 28245} -- Pendant of Dominance
        }
    }, {
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 28246}, -- Band of Triumph
        {2, 28247} -- Band of Dominance
        }
    }, {
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [HORDE_DIFF] = {{1, 28411}, -- General's Silk Cuffs
        ...
        [ALLIANCE_DIFF] = {{1, 29002}, -- Marshal's Silk Cuffs
        ...
        [HORDE_DIFF] = {{1, 28445}, -- General's Dragonhide Bracers
        ...
        [ALLIANCE_DIFF] = {{1, 28978}, -- Marshal's Dragonhide Bracers
        ...
        [HORDE_DIFF] = {{1, 32991}, -- General's Ringmail Bracers
        ...
        [ALLIANCE_DIFF] = {{1, 32994}, -- Marshal's Ringmail Bracers
        ...
        [HORDE_DIFF] = {{1, 28646}, -- General's Scaled Bracers
        ...
        [ALLIANCE_DIFF] = {{1, 28999}, -- Marshal's Scaled Bracers
        ...
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 30609} -- Swift Nether Drake
        }
    }}
}
...
data["ArenaS2PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 32044}, -- Gladiator's Shanker
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 31984}, -- Gladiator's Greatsword
        ...
        name = AL["Weapons"] .. " - " .. ALIL["Off Hand"],
        [NORMAL_DIFF] = {{1, 32045}, -- Gladiator's Shield Wall
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 33066}, -- Veteran's Pendant of Triumph
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 33057}, -- Veteran's Band of Triumph
        {2, 33064}, -- Veteran's Band of Salvation
        {3, 33056} -- Veteran's Band of Dominance
        }
    }, {
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 32820}, -- Veteran's Silk Cuffs
        ...
        name = format(AL["Non Set '%s'"], ALIL["Leather"]),
        [NORMAL_DIFF] = {{1, 32810}, -- Veteran's Dragonhide Bracers
        ...
        name = format(AL["Non Set '%s'"], ALIL["Mail"]),
        [NORMAL_DIFF] = {{1, 32997}, -- Veteran's Ringmail Bracers
        ...
        name = format(AL["Non Set '%s'"], ALIL["Plate"]),
        [NORMAL_DIFF] = {{1, 32819}, -- Veteran's Scaled Bracers
        ...
        name = AL["Gladiator Mount"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 37676} -- Vengeful Nether Drake
        }
    }}
}
...
data["ArenaS3PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 33754}, -- Gladiator's Shanker
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 33688}, -- Gladiator's Greatsword
        ...
        name = AL["Weapons"] .. " - " .. ALIL["Off Hand"],
        [NORMAL_DIFF] = {{1, 33755}, -- Vengeful Gladiator's Shield Wall
        ...
        name = ALIL["Neck"],
        [NORMAL_DIFF] = {{1, 33923}, -- Vindicator's Pendant of Triumph
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 33919}, -- Vindicator's Band of Triumph
        ...
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 33913}, -- Vindicator's Silk Cuffs
        ...
        name = format(AL["Non Set '%s'"], ALIL["Leather"]),
        [NORMAL_DIFF] = {{1, 33881}, -- Vindicator's Dragonhide Bracers
        ...
        name = format(AL["Non Set '%s'"], ALIL["Mail"]),
        [NORMAL_DIFF] = {{1, 33906}, -- Vindicator's Ringmail Bracers
        ...
        name = format(AL["Non Set '%s'"], ALIL["Plate"]),
        [NORMAL_DIFF] = {{1, 33910}, -- Vindicator's Scaled Bracers
        ...
        name = AL["Gladiator Mount"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 34092} -- Merciless Nether Drake
        }
    }}
}
...
data["ArenaS4PvP"] = {
    ...
    items = {{
        ...
        name = AL["Weapons"] .. " - " .. AL["One-Handed"],
        [NORMAL_DIFF] = {{1, 35093}, -- Gladiator's Shanker
        ...
        name = AL["Weapons"] .. " - " .. AL["Two-Handed"],
        [NORMAL_DIFF] = {{1, 35015}, -- Gladiator's Greatsword
        ...
        name = AL["Weapons"] .. " - " .. ALIL["Off Hand"],
        [NORMAL_DIFF] = {{1, 35094}, -- Vengeful Gladiator's Shield Wall
        ...
        name = ALIL["Cloak"],
        [NORMAL_DIFF] = {{1, 44431}, -- Cloak of Certain Reprieve
        ...
        name = ALIL["Finger"],
        [NORMAL_DIFF] = {{1, 35131}, -- Guardian's Band of Triumph
        ...
        name = ALIL["Trinket"],
        [NORMAL_DIFF] = {{1, 41588}, --  Battlemaster's Aggression
        ...
        name = format(AL["Non Set '%s'"], ALIL["Cloth"]),
        [NORMAL_DIFF] = {{1, 35179}, -- Guardian's Silk Cuffs
        ...
        name = format(AL["Non Set '%s'"], ALIL["Leather"]),
        [NORMAL_DIFF] = {{1, 35167}, -- Guardian's Dragonhide Bracers
        ...
        name = format(AL["Non Set '%s'"], ALIL["Mail"]),
        [NORMAL_DIFF] = {{1, 35177}, -- Guardian's Ringmail Bracers
        ...
        name = format(AL["Non Set '%s'"], ALIL["Plate"]),
        [NORMAL_DIFF] = {{1, 35178}, -- Guardian's Scaled Bracers
        ...
        name = AL["Gladiator Mount"],
        ExtraList = true,
        [NORMAL_DIFF] = {{1, 43516} -- Brutal Nether Drake
        }
    }}
}
...
data["NagrandPvP"] = {
    ...
    items = {{
        ...
        [NORMAL_DIFF] = {{
            1,
            28915,
            [PRICE_EXTRA_ITTYPE] = "HalaaBT:70:HalaaRT:15"
        }, -- Reins of the Dark Riding Talbuk
        {
            2,
            27679,
            [PRICE_EXTRA_ITTYPE] = "HalaaBT:100"
        }, -- Sublime Mystic Dawnstone
        {
            3,
            27649,
            [PRICE_EXTRA_ITTYPE] = "HalaaBT:40:HalaaRT:2"
        ...
        }, -- Slayer's Leggings
        {
            11,
            24208,
            [PRICE_EXTRA_ITTYPE] = "money:120000"
        }, -- Design: Mystic Dawnstone
        {14, 26045}, -- Halaa Battle Token
        {
            16,
            29228,
            [PRICE_EXTRA_ITTYPE] = "HalaaBT:100:HalaaRT:20"
        }, -- Reins of the Dark War Talbuk
        {
            17,
            27680,
            [PRICE_EXTRA_ITTYPE] = "HalaaRT:8"
        }, -- Halaani Bag
        {
            18,
            27638,
            [PRICE_EXTRA_ITTYPE] = "HalaaBT:20:HalaaRT:1"
        }, -- Hierophant's Sash
        {
            19,
            27645,
        ...
        }, -- Slayer's Waistguard
        {
            26,
            33783,
            [PRICE_EXTRA_ITTYPE] = "HalaaRT:4"
        }, -- Design: Steady Talasite
        {
            27,
            32071,
            [PRICE_EXTRA_ITTYPE] = "HalaaRT:2"
        }, -- Recipe: Elixir of Ironskin
        {29, 26044} -- Halaa Research Token
        }
    }, {
        MapID = 3518,
        [ALLIANCE_DIFF] = {{1, 30611}, -- Halaani Razorshaft
        ...
        [HORDE_DIFF] = {{1, 30611}, -- Halaani Razorshaft
        {2, 30612}, -- Halaani Grimshot
        {3, 30615}, -- Halaani Whiskey
...
data["TerokkarPvP"] = {
    ...
    items = {{
        MapID = 3519,
        [NORMAL_DIFF] = {{1, 28553}, -- Band of the Exorcist
...
data["ZangarmarshPvP"] = {
    ...
    items = {{
        ...
        [ALLIANCE_DIFF] = {{
            1,
            27990,
            [PRICE_EXTRA_ITTYPE] = "MarkOfHonorHold:15"
        }, -- Idol of Savagery
        {
            2,
            27984,
        ...
        {8, 24579}, -- Mark of Honor Hold
        {
            16,
            27922,
            [PRICE_EXTRA_ITTYPE] = "MarkOfHonorHold:30"
        }, -- Mark of Defiance
        {
            17,
            27920,
        ...
        [HORDE_DIFF] = {{
            1,
            27990,
            [PRICE_EXTRA_ITTYPE] = "MarkOfThrallmar:5"
        }, -- Idol of Savagery
        {
            2,
            27984,
            [PRICE_EXTRA_ITTYPE] = "MarkOfThrallmar:15"
        }, -- Totem of Impact
        {
            3,
            27929,
        ...
        {8, 24581}, -- Mark of Thrallmar
        {
            16,
            27922,
            [PRICE_EXTRA_ITTYPE] = "MarkOfThrallmar:30"
        }, -- Mark of Defiance
        {
            17,
            27920,
